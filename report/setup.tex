...
\renewcommand*{\glspostdescription}{\vspace{0.6em}}
...
\newglossaryentry{developer}{name=developer,description={Κατασκευαστής λογισμικού}}
\newglossaryentry{indie_game}{name=indie game,description={Παιχνίδι που αναπτύσσεται από μικρή ομάδα ανεξάρτητων προγραμματιστών}}
\newglossaryentry{mobile_game}{name=mobile game,description={Παιχνίδι που σχεδιάστηκε για να εκτελείται σε κινητές συσκευές}}
\newglossaryentry{tech_stream}{name=Tech Stream,description={Εκδόσεις του Unity Editor που προσφέρουν πρόσβαση σε όλες τις τελευταίες υπό εξέλιξη λειτουργίες και ενημερώσεις}}
\newglossaryentry{q1}{name=Q1,description={Πρώτο τρίμηνο του έτους}}
\newglossaryentry{q4}{name=Q4,description={Τελευταίο τρίμηνο του έτους}}
\newglossaryentry{open_source}{name=open source,description={Λογισμικό του οποίου ο πηγαίος κώδικας είναι διαθέσιμος για το κοινό}}
\newglossaryentry{rendering}{name=rendering,description={Διαδικασία απεικόνισης ενός αντικειμένου σε μία οθόνη}}
\newglossaryentry{photorealistic}{name=photorealistic,description={Αναπαράσταση ενός αντικειμένου με τρόπο που μοιάζει με φωτογραφία}}
\newglossaryentry{avatar}{name=avatar,description={Εικονικός χαρακτήρας που χρησιμοποιείται για την αναπαράσταση του παίκτη}}
\newglossaryentry{repo}{name=repository,description={Αποθετήριο κώδικα που χρησιμοποιείται για την αποθήκευση και τη διαχείριση του πηγαίου κώδικα}}
\newglossaryentry{backend}{name=backend,description={Πίσω μέρος ενός συστήματος που ασχολείται με την επεξεργασία των δεδομένων}}
\newglossaryentry{script}{name=script,description={Πρόγραμμα που εκτελείται από τον υπολογιστή}}
